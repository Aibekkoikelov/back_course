...
const userRouter = require('./routers/userRouter'); // импортируем роутер
app.use("/users", userRouter)  // ПЕрвый параметр - префикс( префикс устанавливает перед всеми роутами данного роута), второй - сам роут )
