...
// Реляционная база данных - это система управления базами данных, которая позволяет создавать, читать, обновлять и удалять данные из базы данных.
// Нерялиционная база данных - это система управления базами данных, которая позволяет создавать, читать, обновлять и удалять данные из базы данных.
// отличие реляционной базы данных от нереляционной базы данных в том, что реляционная база данных хранит данные в виде таблиц, а нереляционная база данных хранит данные в виде документов.

// Виды реляционных баз данных:
// 1. MySQL
// 2. PostgreSQL
// 3. SQLite
...
// Что такое ORM?
// ORM - это Object-Relational Mapping, то есть объектно-реляционное отображение. ORM - это библиотека, которая позволяет взаимодействовать с базой данных, используя объектно-ориентированный подход.

// Что такое Migrations?
// Migrations - это система контроля версий для базы данных. Migrations - это система, которая позволяет контролировать изменения в базе данных, которые происходят при разработке приложения.

// ЧТо такое  seeders?
// Seeders - это система, которая позволяет заполнять базу данных начальными данными.
